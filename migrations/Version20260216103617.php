 ...
 */
final class Version20260216103617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD banner_filename VARCHAR(255) DEFAULT NULL, ADD bio LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP banner_filename, DROP bio');
